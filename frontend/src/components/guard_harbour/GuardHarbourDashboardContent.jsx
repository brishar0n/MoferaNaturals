...
import { getCheckpoints, getShippingInfo, getPackages, getPackagesWithStatus } from '../../../api/guardHarborAPI';
...
function GuardHarbourDashboardContent() {
    ...
    return (
        <>
            ...
            <CheckpointStats checkpointData={checkpoints} packageShippedData={packageShippingData} packageConfirmedData={packageConfirmedData}/>

            <div className="p-4 relative mt-1 -mb-24">
                <p className="text-white font-bold text-lg">Packages</p>
                <PackageConfirmation searchResult={searchResult} shippingData={shippingData}/>
            </div>
        </>
    )
